...
export default function ProfileMenu() {
  ...
  return (
    <div className='container'>
      ...
      <button className="flex mx-3 text-sm rounded-full md:mr-0 focus:ring-2 focus:ring-gray-600" type="button" onClick={() => setDropdown((prevState) => !prevState)}>
...

      {
        ...
        <div id="dropdownInformation" className="absolute top-20 right-20 z-10 divide-y rounded-lg shadow w-44 bg-gray-700 divide-gray-600">
          ...
          <ul className="py-2 text-sm text-gray-700 dark:text-gray-200">
            <li>
              <Link to="dashboard" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Your Events</Link>
            </li>
            <li>
